...
def calc_kcor(redshift, colour_value, filter_name='r', colour_name='g - r'):
    """
    Update for PHYS 321:
    Takes filter_name = 'r' as default, and also assumes that
    the colour that is being provided is 'g-r'
    Also does the 1.3*z redshift evolution correction
